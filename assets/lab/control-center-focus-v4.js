(() => {
  ...
  function bootFocusLayer() {
    ...
    if (!shell || !drawers.length) return;
  ...
  if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', bootFocusLayer, { once: true });
  else bootFocusLayer();
})();
