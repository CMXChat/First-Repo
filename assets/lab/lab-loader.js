(() => {
  ...
  const BUILD = "20260819-planner-signals-v3";
  ...
  const LAB_STYLES = Object.freeze([
    ...
    ["lab-continuum-planner-preflight-v1.css", "20260819-v1r3"],
  ...
  const LAB_SCRIPTS = Object.freeze([
    ...
    ["lab-continuum-planner-preflight-v1.js", "20260819-v1r3"],
  ...
  function transformSnapshot(source) {
    ...
    if (!html.includes("/assets/lab/lab-continuum-planner-preflight-v1.js")) throw new Error("Shared Continuum Planner preflight layer was not inserted.");
    if (!html.includes("/assets/lab/lab-continuum-planner-preflight-v1.css")) throw new Error("Shared Continuum Planner preflight styling was not inserted.");
