(()=>{
  ...
  const ensureCss=(href)=>{if(!document.querySelector(`link[href^="${href}"]`)){const l=document.createElement('link');l.rel='stylesheet';l.href=`${href}?v=20260812-9`;document.head.appendChild(l)}};
  ensureCss('/assets/study-course-nav.css');ensureCss('/assets/study-enhancements.css');ensureCss('/assets/study-layout-fixes.css');ensureCss('/assets/study-universe.css');ensureCss('/assets/study-tutor-v2.css');ensureCss('/assets/study-navigation-fixes.css');ensureCss('/assets/study-concept-machines.css');ensureCss('/assets/study-focus-nav.css');ensureCss('/assets/study-deep-labs.css');ensureCss('/assets/study-docker-v2.css');ensureCss('/assets/study-self-check.css');ensureCss('/assets/study-handbook-sync.css');
  ...
  const ensureScript=(src)=>{if(!document.querySelector(`script[src^="${src}"]`)){const s=document.createElement('script');s.src=`${src}?v=20260812-9`;s.async=false;document.head.appendChild(s)}};
  ensureScript('/assets/study-enhancements.js');ensureScript('/assets/study-universe.js');ensureScript('/assets/study-tutor-v2.js');ensureScript('/assets/study-nav-final.js');ensureScript('/assets/study-concept-machines.js');ensureScript('/assets/study-focus-nav.js');ensureScript('/assets/study-deep-labs.js');ensureScript('/assets/study-docker-v2.js');ensureScript('/assets/study-handbook-sync.js');ensureScript('/assets/study-self-check.js');
})();