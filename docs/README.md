...
| `briefing-design-standard.md` | Supporting design reference. Current light-first visual behavior wins when examples conflict. |
...
- `/brief/`: public noindex Personal OS demonstration, light by default, manual dark mode retained.
