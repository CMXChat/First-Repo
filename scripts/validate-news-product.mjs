...
const resilienceBounds = read('assets/news-resilience-bounds.js');
...
expect(loader.includes('/assets/news-resilience-bounds.js'), 'loader includes news-resilience-bounds.js');
...
expect(loader.indexOf('/assets/news-resilience.js') < loader.indexOf('/assets/news-resilience-bounds.js'), 'pixel bounds load after resilience');
...
expect(browserSpec.includes('CMX_NEWS_RESILIENCE_BOUNDS.applyBounds'), 'browser tests execute the pixel-safe bounds');
