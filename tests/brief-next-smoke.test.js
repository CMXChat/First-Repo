...
assert.equal((html.match(/<script src=/g) || []).length, 9, 'Spaces should load data, advanced modules, branding, experience, media, app, explainers, conversation and deep-navigation scripts.');
