...
assert.match(html, /id="entryScenarioGrid" role="group" aria-label="Demo contexts"/);
...
assert.match(html, /brief-demo-doc-links\.css\?v=20260806-2/);
...
assert.match(topbarPolishCss, /#themeButton\s*\{[\s\S]*box-shadow/);
assert.match(topbarPolishCss, /html\[data-theme="dark"\] #themeButton/);
assert.match(topbarPolishCss, /\.entry-option small\s*\{[\s\S]*color: #5f7084/);
assert.match(topbarPolishCss, /\.muted-pill\s*\{[\s\S]*color: #66768a/);
assert.match(topbarPolishCss, /\.hourly-item time\s*\{[\s\S]*color: #2f4257/);
