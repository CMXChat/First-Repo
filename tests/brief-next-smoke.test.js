...
assert.match(html, /id="openDemoLabel">Open Personal Space/);
...
assert.match(html, /brief-demo-conversation\.css\?v=20260808-2/);
...
assert.match(html, /brief-demo-app\.js\?v=20260808-1/);
