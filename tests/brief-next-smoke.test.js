...
assert.match(html, /brief-demo-experience\.css\?v=20260808-3/);
assert.match(html, /brief-demo-doc-links\.css\?v=20260808-1/);
assert.match(html, /brief-demo-topbar-polish\.css\?v=20260807-3/);
assert.match(html, /brief-demo-advanced\.css\?v=20260808-2/);
assert.match(html, /brief-demo-conversation\.css\?v=20260808-13/);
assert.match(html, /brief-spaces-runtime\.js\?v=20260806-1/);
assert.match(html, /brief-demo-data\.js\?v=20260808-3/);
assert.match(html, /brief-demo-advanced\.js\?v=20260808-2/);
assert.match(html, /brief-demo-experience\.js\?v=20260808-1/);
assert.match(html, /brief-demo-media\.js\?v=20260807-4/);
assert.match(html, /brief-demo-app\.js\?v=20260808-8/);
