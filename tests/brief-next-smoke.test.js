...
assert.match(html, /brief-demo-conversation\.css\?v=20260808-5/);
assert.match(html, /brief-spaces-runtime\.js\?v=20260806-1/);
assert.match(html, /brief-demo-data\.js\?v=20260808-1/);
...
assert.match(html, /brief-demo-app\.js\?v=20260808-2/);
