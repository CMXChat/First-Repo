...
const redirect=fs.readFileSync('lab/email/index.html','utf8');
...
must(redirect,'url=/email/','old Lab route redirect');
...
console.log('Continuum Email root-route contract: PASS');
