...
assert.match(appJs, /function alignWorkspaceDestination\(/);
assert.match(appJs, /scrollBelowTopbar\(\$\('#workspaceTabNavigation'\)/);
...
assert.match(html, /class="theme-toggle spaces-theme-toggle" id="themeButton"/);
assert.match(html, /theme-option theme-option-dark">Dark/);
assert.match(html, /theme-option theme-option-light">Light/);
assert.match(topbarPolishCss, /\.spaces-theme-toggle\s*\{[\s\S]*background: color-mix/);
assert.match(topbarPolishCss, /\.spaces-theme-toggle \.theme-toggle-track/);
assert.match(topbarPolishCss, /html\[data-theme="light"\] \.spaces-theme-toggle \.theme-toggle-thumb/);
assert.match(topbarPolishCss, /html\[data-theme="dark"\] \.spaces-theme-toggle/);
...
assert.match(advancedCss, /\.priority-routing-dialog/);
assert.match(advancedCss, /\.priority-channel-switch/);
assert.match(advancedCss, /\.project-dashboard \{ overflow-x: visible/);
assert.match(advancedCss, /\.portfolio-command \{ grid-template-columns: minmax\(0, 1fr\)/);
...
assert.match(conversationCss, /@media \(max-width: 620px\)[\s\S]*\.entry-space-preview \{\s*display: none;/);
