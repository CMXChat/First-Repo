...
assert.match(bridge, /role-based member, project and leadership spaces/);
...
assert.match(bridge, /intro\.textContent !== TERMINAL_INTRO/);
assert.match(bridge, /summary\.textContent !== TERMINAL_SUMMARY/);
